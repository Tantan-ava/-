...
SCRIPTS = [
    {'name': 'run_experiments', 'path': SRC_DIR / 'run_experiments.py', 'timeout': 300},
    {'name': 'run_optimization_experiments', 'path': SRC_DIR / 'run_optimization_experiments.py', 'timeout': 300},
    {'name': 'run_week8_tutorial', 'path': SRC_DIR / 'run_week8_tutorial.py', 'timeout': 900},
